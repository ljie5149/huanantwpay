...
echo "ori_sid :$ori_sid\n";
        ...
        public function modifyDataOrder($link, $year, $input, &$ret_msg, $skip_resp = false)
        {
            ...
            $array_field_src = ['scanType','storeId','endpointCode'
                                ...
                                ,'api', 'api_zhtw', 'operate_src','resp_code','resp_msg','twqr_resp_msg'
                                ...
                                ,'pay_time','pay_method','pay_method01','pay_status','amount','request','response','txnType_code','txnType_msg','notify_resp_msg','avalible','remark'];
        ...
        public function saveLog($link, $input, &$ret_msg) {
            ...
            $array_field_src = ['type','scanType','storeId','endpointCode'
                                ...
                                ,'resp_code','resp_msg','twqr_resp_msg','request','response','txnType_code','txnType_msg','remark'];
            $fields = ""; $values = "";
