...
// close connection at finally
	...
	*/
	...
	function setPayStatus($url, $parking_id, $order_no, $realpay, $discount, $pay_status, $pay_log, $bill_no, $payment_order_no, $pay_method, $pay_source, $jko_coin = "0") {
		/*
	...
	function getInvoice($url, $parking_id, $order_no, $plate_no, $amount, $carrierId1, $carrierId2, $email, $carrierType, $loveId) {
		/*
			<<<<< getInvoice request :{
			"name": "RFP-0039",
			"amount": "20",
