<?php
	...
	$table = 'data_order';
	$reuqire_fields 	= ['paymode','orderNo','amount','QRcode','payment_order_no','bill_no','PosArea','parking_id','device_id'];
    ...
    $mode	    	= isset($_POST['paymode'    ]) ? $_POST['paymode'    ] : ''				; // creditbyscan, debit
