...
<html>
              ...
              <!-- Illustrations -->
			   <div class="col-sm-12">
                <div class="ibox float-e-margins">
				  ...
				  <div>
				    <form action="history4zhudong.php" method="Post" name='frm1' id='frm1'>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
						...
						<?php
							...
							$havedata = 0;
							$sql = "SELECT * FROM `log_history4user` WHERE DATE(start_time)>='$sd' AND DATE(start_time)<='$ed' 
                        			$station_condiction ";
							...
							// 充電資訊
							$charge_info = getDailyInfo($add_visible, $sd, $ed, $station_name);
							echo $charge_info;
	...
	//											echo " <button type='button' class='btn btn-info ml-auto' onclick=Edit('".$fid."')>編輯</button>";
											...
											$pages = 0;
											$havedata = 0;
											echo "<div>本場域今日尚無充電訂單，查詢其他區間請選擇日期!</div>";
										}
									}
...
<script>
	...
	function Add()
	{
		...
		document.getElementById("ret_page").value ='history4zhudong';
